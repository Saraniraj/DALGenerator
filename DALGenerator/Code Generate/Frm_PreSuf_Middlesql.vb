...
Public Class Frm_PreSuf_Middlesql
    ...
    Private Sub btnAdd_Click(sender As Object, e As EventArgs) Handles btnAdd.Click
        Try
            ...
            For i As Integer = 0 To RtboxLeft.Lines.Length - 1
                ...
                RtboxRight.Text &= TxtPrefix.Text & RtboxLeft.Lines(i) & TxtMiddle.Text & RtboxLeft.Lines(i) & Txtsuffix.Text & If(i < RtboxLeft.Lines.Length - 1, Environment.NewLine, "")
            Next
